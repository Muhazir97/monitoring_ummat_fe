            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="(row, i) in table.data" :key="i">
                  ...
                  <td style="font-size: 13px;">{{row.jabatan}}</td>
                  <td style="font-size: 13px;">{{row.provinsi}}</td>
                  <td style="font-size: 13px;">{{row.kota}}</td>
                  <td style="font-size: 13px;">{{row.nik}}</td>
                  <!-- <td>
...
<script>
  ...
  export default {
    ...
    methods: {
      get(param){
        let context = this;               
        Api(context, anggota.index({search: this.search})).onSuccess(function(response) {    
